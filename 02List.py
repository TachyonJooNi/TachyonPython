...
# print('list2[5];', list2[5])  => index out of reang : 오류발생
...
# 반환 및 삭제 : 리스트의 마지막 원소를 반환하고 삭제한다.
print(list1.pop())
print('pop()=>', list1)
...
'''
List Comprehension
  : 대괄호 안에 for루프로 반복전인 표현식을 실행해서 리스트
  원소들을 초기화 하는 방법이다.
  형식]
    [표현식 for 원소 in 컬렉션 [if 조건식]]
'''
...
list1: [1, 2, 3, 4, 5]
list2[2]: Python
list3[2]: ['Java', 'HTML', 'Python']
===슬라이싱 ==============================
list1[1:4]: [2, 3, 4]
list1[:3]: [1, 2, 3]
list1[1:]: [2, 3, 4, 5]
list2[:3]; ['Java', 'HTML', 'Python']
list2[:4]; ['Java', 'HTML', 'Python']
list2[:5]; ['Java', 'HTML', 'Python']
===리스트 연결 ==============================
all_list: [[1, 2, 3, 4, 5], ['Java', 'HTML', 'Python']]
all_list[1][0]: Java
===list 관련 메서드 ==============================
append(6)=> [1, 2, 3, 4, 5, 6]
clear()=> []
extend=> [10, 20, 30, 40, 50]
insert=> [10, 99, 20, 30, 40, 50]
50
pop()=> [10, 99, 20, 30, 40]
remove=> [10, 20, 30, 40]
reverse()=> [40, 30, 20, 10]
